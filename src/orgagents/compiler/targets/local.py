...
class LocalTarget:
    ...
    def generate(self, ir: SystemIR) -> list[GeneratedFile]:
        files = [
            ...
            # enforced by NATS as well as by both workers (ADR-0118).
                    ...
                    json.dumps(
                        {
                            ...
                            # here, never by the worker (ADR-0118).
    ...
    def _requirements(self, ir: SystemIR) -> str:
        ...
        # Every agent container is on the tenant's bus (ADR-0118).
    ...
    def _agent_service(self, ir: SystemIR, agent) -> dict[str, Any]:
        ...
        service: dict[str, Any] = {
            ...
            "environment": {
                ...
                # inboxes its edges reach, as itself (ADR-0118).
