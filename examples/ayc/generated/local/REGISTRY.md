...
`local`. This is the fleet inventory: every agent, its owner, its identity,
...
|---|---|---|---|---|---|---|---|
| `ap_agent` | canned | balanced | — | us-central1 | not checked | — | — |
| `ar_agent` | canned | balanced | — | us-central1 | not checked | — | — |
| `buyer_agent` | canned | balanced | — | us-central1 | not checked | — | — |
| `ceo_agent` | canned | balanced | — | us-central1 | not checked | — | — |
| `cgo_agent` | canned | balanced | — | us-central1 | not checked | — | — |
| `coo_agent` | canned | balanced | — | us-central1 | not checked | — | — |
| `cs_agent` | canned | balanced | — | us-central1 | not checked | — | — |
| `ecommerce_agent` | canned | balanced | — | us-central1 | not checked | — | — |
| `inventory_agent` | canned | balanced | — | us-central1 | not checked | — | — |
| `marketing_agent` | canned | balanced | — | us-central1 | not checked | — | — |
| `software_agent` | canned | balanced | — | us-central1 | not checked | — | — |
| `warehouse_agent` | canned | balanced | — | us-central1 | not checked | — | — |
...
|---|---|---|---|---|---|---|
| `ops_desk` | internal | ops-desk | notify | — | 0 step(s) | — |
| `growth_desk` | internal | growth-desk | ask, notify | — | 0 step(s) | — |
